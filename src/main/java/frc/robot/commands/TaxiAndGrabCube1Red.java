...
public class TaxiAndGrabCube1Red extends SequentialCommandGroup
{
  ...
  public TaxiAndGrabCube1Red(DriveSubsystem driveSubsystem, Claw claw, Shoulder shoulder, Wrist wrist,  HashMap<String, Command> eventMap) 
  {
    ...
    PathPlannerTrajectory path = PathPlanner.loadPath("TaxiAndGrabCube1Red", new PathConstraints(2, 2));
