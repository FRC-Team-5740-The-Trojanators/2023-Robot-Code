...
public class TaxiAndGrabCube1RedNoBal extends SequentialCommandGroup
{
  ...
  public TaxiAndGrabCube1RedNoBal(DriveSubsystem driveSubsystem, Claw claw, Shoulder shoulder, Wrist wrist,  HashMap<String, Command> eventMap) 
  {
    ...
    PathPlannerTrajectory path = PathPlanner.loadPath("TaxiAndGrabCube1RedNoBalance", new PathConstraints(2, 2));
