...
public class Taxi3 extends SequentialCommandGroup
{
  ...
  public Taxi3(DriveSubsystem driveSubsystem, Claw claw, Shoulder shoulder, Wrist wrist,  HashMap<String, Command> eventMap) 
  {
    ...
    PathPlannerTrajectory path = PathPlanner.loadPath("Position3", new PathConstraints(1, 2));
