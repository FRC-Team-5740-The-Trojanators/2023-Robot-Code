...
public class TaxiAndGrabCube1BlueNoBal extends SequentialCommandGroup
{
  ...
  public TaxiAndGrabCube1BlueNoBal(DriveSubsystem driveSubsystem, Claw claw, Shoulder shoulder, Wrist wrist,  HashMap<String, Command> eventMap) 
  {
    ...
    PathPlannerTrajectory path = PathPlanner.loadPath("TaxiAndGrabCube1BlueNoBalance", new PathConstraints(2, 2));
