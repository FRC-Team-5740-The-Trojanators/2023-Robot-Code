...
public class TaxiAndBalance2 extends SequentialCommandGroup
{
  ...
  public TaxiAndBalance2(DriveSubsystem driveSubsystem, Claw claw, Shoulder shoulder, Wrist wrist,  HashMap<String, Command> eventMap) 
  {
    ...
    PathPlannerTrajectory path = PathPlanner.loadPath("Position2", new PathConstraints(1, 2));
